...
var PipeError = (function (_Error) {
    _inherits(PipeError, _Error);

    function PipeError(errors, count) {
        _classCallCheck(this, PipeError);

        _get(Object.getPrototypeOf(PipeError.prototype), "constructor", this).call(this, count + " errors occured during pipe flow! See them in the errors property!");
        this.errors = errors;
        this.count = count;
    }

    _createClass(PipeError, [{
        key: "getErrors",
        value: function getErrors() {
            ...
            Object.keys(this.errors).forEach(function (k) {
                return o[k] = _this.errors[k].message;
            });
            return o;
        }
    }]);
